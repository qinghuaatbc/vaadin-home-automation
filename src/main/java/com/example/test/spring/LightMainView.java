...
@Push
@Route("push/mainLight")
public class LightMainView extends Div {
   ...
   private FeederThread thread;
    ...
    private static class FeederThread extends Thread {
        ...
        private final LightMainView view;

        private int count = 0;

        public FeederThread(UI ui, LightMainView view) {
            this.ui = ui;
            this.view = view;
        }
