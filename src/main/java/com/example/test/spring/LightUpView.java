...
@Push
@Route("push/upLight")
public class LightUpView extends Div {

   private FeederThread thread;
    List<LightButton> mainLights = Arrays.asList(

            new LightButton("bed1", "19 51 94 1", 300, 300),
            new LightButton("bed2", "19 51 94 1", 200, 200),
            new LightButton("bed3", "19 21 94 1", 500, 500),
    ...
    private static class FeederThread extends Thread {
        ...
        private final LightUpView view;

        private int count = 0;

        public FeederThread(UI ui, LightUpView view) {
            this.ui = ui;
            this.view = view;
        }
